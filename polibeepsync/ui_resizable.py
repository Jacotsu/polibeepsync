...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.notifyNewCourses = QtGui.QCheckBox(self.tab)
        self.notifyNewCourses.setObjectName("notifyNewCourses")
        self.verticalLayout_2.addWidget(self.notifyNewCourses)
        ...
        self.license = QtGui.QPushButton(self.tab_3)
        self.license.setObjectName("license")
        self.horizontalLayout_8.addWidget(self.license)
    ...
    def retranslateUi(self, Form):
        ...
        self.notifyNewCourses.setText(QtGui.QApplication.translate("Form", "Notify new available courses", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.license.setText(QtGui.QApplication.translate("Form", "License", None, QtGui.QApplication.UnicodeUTF8))
