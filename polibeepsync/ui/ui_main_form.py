...
"")
        ...
        self.status = QPlainTextEdit(self.status_tab)
        self.status.setObjectName(u"status")
        self.status.setAcceptDrops(False)
        self.status.setStyleSheet(u"/* https://github.com/martinrotter/qt-material-stylesheet */\n"
"\n"
"QWidget:window {					/* Borders around the code editor and debug window */\n"
"	border: 0px solid #FFFFFF;\n"
"	background-color: #FFFFFF;\n"
...
"")
        ...
        self.status.setCenterOnScroll(True)
        ...
        QWidget.setTabOrder(self.about, self.rootfolder)
    ...
    def retranslateUi(self, MainForm):
        ...
        self.status.setPlaceholderText(QCoreApplication.translate("MainForm", u"Status console:", None))
