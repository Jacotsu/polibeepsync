...
1. Insert usercode and password

   * Click "Try login credentials".
     If you get a text saying ``Successful login`` on the status bar then continue
...
3. Go back to the ``Settings`` tab, press the ``Change`` button
